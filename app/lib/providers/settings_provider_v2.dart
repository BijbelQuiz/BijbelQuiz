...
/// Enhanced SettingsProvider using the centralized sync service
class SettingsProvider extends ChangeNotifier {
  static const String _themeModeKey = 'theme_mode_v2';
  static const String _customThemeKey = 'custom_theme_v2';
  static const String _unlockedThemesKey = 'unlocked_themes_v2';
  static const String _slowModeKey = 'game_speed_v2';
  static const String _hasSeenGuideKey = 'has_seen_guide_v2';
  static const String _muteKey = 'mute_v2';
  static const String _notificationEnabledKey = 'notification_enabled_v2';
  static const String _hasDonatedKey = 'has_donated_v2';
  static const String _hasCheckedForUpdateKey = 'has_checked_for_update_v2';
  static const String _lastDonationPopupKey = 'last_donation_popup_v2';
  static const String _lastFollowPopupKey = 'last_follow_popup_v2';
  static const String _lastSatisfactionPopupKey = 'last_satisfaction_popup_v2';
  static const String _hasClickedDonationLinkKey = 'has_clicked_donation_link_v2';
  static const String _hasClickedFollowLinkKey = 'has_clicked_follow_link_v2';
  static const String _hasClickedSatisfactionLinkKey = 'has_clicked_satisfaction_link_v2';
  static const String _lastDifficultyPopupKey = 'last_difficulty_popup_v2';
  static const String _hasClickedDifficultyLinkKey = 'has_clicked_difficulty_link_v2';
  static const String _difficultyPreferenceKey = 'difficulty_preference_v2';
  static const String _analyticsEnabledKey = 'analytics_enabled_v2';
  static const String _aiThemesKey = 'ai_themes_v2';
  static const String _apiEnabledKey = 'api_enabled_v2';
  static const String _apiKeyKey = 'api_key_v2';
  static const String _apiPortKey = 'api_port_v2';
  static const String _showNavigationLabelsKey = 'show_navigation_labels_v2';
  static const String _layoutTypeKey = 'layout_type_v2';
  static const String _colorfulModeKey = 'colorful_mode_v2';
  static const String _hidePromoCardKey = 'hide_promo_card_v2';
  ...
  /// The current language setting (always 'nl')
  ...
  Future<void> unlockTheme(String key) async {
    if (!_unlockedThemes.contains(key)) {
      ...
      // Sync the updated settings
      if (CentralizedSyncService.instance.isInRoom) {
        await CentralizedSyncService.instance.syncData('settings', getExportData());
      }
    }
  }
  ...
  Future<void> _saveSetting({
    ...
    try {
      ...
      // Sync settings after any change
      if (CentralizedSyncService.instance.isInRoom) {
        await CentralizedSyncService.instance.syncData('settings', getExportData());
      }
    } catch (e) {
  ...
  /// Loads settings data from import (for sync)
  Future<void> loadImportData(Map<String, dynamic> data) async {
    try {
      ...
      AppLogger.info('Settings loaded from sync data');
      notifyListeners();
    } catch (e) {
      AppLogger.error('Failed to load settings from sync data', e);
    }
  }

  /// Sets up sync listener for real-time updates
  void _setupSyncListener() {
    CentralizedSyncService.instance.addListener('settings', loadImportData);
  }
  ...
  /// Forces immediate sync of current settings
  Future<void> forceSync() async {
    if (CentralizedSyncService.instance.isInRoom) {
      await CentralizedSyncService.instance.syncData('settings', getExportData());
      AppLogger.info('Forced sync of settings');
    }
  }
}