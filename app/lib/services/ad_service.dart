...
class AdService {
  ...
  Future<Ad?> getRandomAd() async {
    try {
      ...
      AppLogger.warning('Error fetching random ad from Supabase (offline or database error): $e');
      return null;
    }
  }
  ...
  Future<List<Ad>> getAllActiveAds() async {
    try {
      ...
      AppLogger.warning('Error fetching all active ads from Supabase (offline or database error): $e');
      return [];
    }
  }
  ...
  Future<bool> isOnline() async {
    try {
      ...
      AppLogger.warning('Database connectivity test failed, likely offline: $e');
      return false;
    }
  }
